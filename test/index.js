...
describe("API ENDPOINT TESTING", () => {
	it("GET API Landing Page", (done) => {
		...
		it("GET API Detail Page", (done) => {
			chai
				.request(app)
				.get("/api/v1/member/detail-page/5e96cbe292b97300fc902231")
				.end((err, res) => {
					expect(err).to.be.null;
					expect(res).to.have.status(200);
					expect(res.body).to.be.an("object");
		...
		it("GET API Booking Page", (done) => {
			const image = __dirname + "/buktibayar.jpeg";
			const dataSample = {
				image,
				idItem: "5e96cbe292b97300fc902231",
				duration: 2,
				bookingStartDate: "2-8-2021",
				bookingEndDate: "4-8-2021",
				firstName: "Griaa",
				lastName: "Dinata",
				email: "griaadinata@gmail.com",
				phoneNumber: "08128398293",
				accountHolder: "Griaa Dinata",
				bankFrom: "Mandiri",
			};
			chai
				.request(app)
